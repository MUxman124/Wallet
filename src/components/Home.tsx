  ...
  return (
    <div className="max-w-3xl bg-gradient-to-r from-teal-400 via-emerald-300 to-green-300 p-10 text-4xl font-bold mt-20 rounded shadow-lg hover:shadow-none transition-shadow duration-500 shadow-emerald-400 mx-auto ">
      ...
      <div className="flex-shrink-0">
        ...
        <a
          className="inline-block rounded border border-black px-2  py-3 text-sm font-medium text-black hover:text-white focus:outline-none focus:ringh hover:bg-neutral-800 transition-colors duration-300"
          href="/download"
        >
